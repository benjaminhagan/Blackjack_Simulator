...
class BlackjackGame():
    ...
    def start_hand(self):    
        ...
        if self.player_hands[0].value == 21 or self.dealer_hand.value + self.dealer_down_card.value == 21:
...
class BlackjackSimulator():
    ...
    def simulate_risk_of_ruin(self, start_bankroll, sl, tp, min_bet_size, play_deviations, trials_to_run, spread=None, flooring=False, print_hands=False):
        ...
        risk_of_ruin = losses / trials_to_run
        return risk_of_ruin
...
def calculate_move_logic(dealer_hand: Hand, player_hand: Hand, max_splits_reached=False, play_deviations=False, true_count=0, running_count=0):
    ...
    if play_deviations:
        ...
        # if up_card == 11 and true_count >= 3:
